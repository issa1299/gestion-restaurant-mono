...
class ParametreForm(forms.ModelForm):
    smtp_mot_de_passe = forms.CharField(
        ...
        widget=forms.PasswordInput(attrs={
            ...
            'placeholder': 'Clé d\'application (laisser vide pour conserver)',
    ...
    class Meta:
        ...
        fields = ['nom', 'adresse', 'telephone', 'email', 'logo', 'devise', 'message_ticket', 'impression_silencieuse',
        ...
        widgets = {
            ...
            'impression_silencieuse': forms.CheckboxInput(attrs={'class': 'w-5 h-5 rounded border-gray-300 text-orange-500 focus:ring-orange-500'}),
