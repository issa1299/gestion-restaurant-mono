...
# En dev : clé de secours si la variable d'environnement n'est pas définie.
# En prod : config/settings_prod.py exige SECRET_KEY via l'environnement.
SECRET_KEY = os.environ.get('SECRET_KEY') or 'django-insecure-dev-restaurantpro-mono-local-only'
